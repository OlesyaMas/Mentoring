...
public class CalculatorDemo {
	...
	public static void main(String[] args) {
		...
		do {
			...
			double num1 = 0;
			do {
				printText("Введіть перший операнд:");
			...
			do {
				...
				printText("Введіть операцію (тільки арифметичні, без пам'яті ('+,-,/,*')):");
			...
			do {
				printText("Введіть другий операнд або візьміть його з пам'яті ('mr'):");
			...
			do {
				...
				printText("Додати/відняти в пам'яті ('m+','m-'):");
